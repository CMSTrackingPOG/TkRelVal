...
printf "     <body>\n" >> index.html  
printf "          <a href=\"%s/%s/%s/PO\">dEdx DQMHarm2PO</a>\n" ${web} ${release} >> index.html
printf "          <br />\n" >> index.html    
printf "          <a href=\"%s/%s/%s/SO\">dEdx DQMHarm2SO</a>\n" ${web} ${release} >> index.html
printf "          <br />\n" >> index.html    
printf "          <a href=\"%s/%s/%s/SP\">dEdx DQMHarm2SP</a>\n" ${web} ${release} >> index.html
printf "          <br />\n" >> index.html    
printf "          <a href=\"%s/%s/%s/HitInfo\">dEdxHitInfo</a>\n" ${web} ${release} >> index.html
printf "     </body>\n" >> index.html
printf "</html>\n" >> index.html
