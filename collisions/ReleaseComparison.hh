...
void CMSLumi(TCanvas *& canv, const Int_t iPosX, const Int_t tev, const Double_t lumi, const Bool_t collisions);
bool createTH1FPlot (const TString hname, const TString dirname, TFile *& V1file, const TString runstring1, 
		     ...
		     const Double_t V2_integral, TString outdir, const Double_t lumi, const Int_t tev, const Bool_t collisions);
